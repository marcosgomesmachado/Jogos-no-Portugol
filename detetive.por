...
funcao DesenhaTelaCarregamento()
{
	...
	enquanto (progresso <= 100)
	{
		...
		inteiro blocos = progresso / 3

		para (inteiro i = 0; i < blocos; i++)
		{
			escreva("█")
		}

		para (inteiro i = blocos; i < 34; i++)
		{
			escreva(" ")
		}

		cadeia progresso_texto = tp.inteiro_para_cadeia(progresso, 10)

		

		escreva(" ",  t.preencher_a_esquerda(' ', 3, progresso_texto), "%        ║\n")
